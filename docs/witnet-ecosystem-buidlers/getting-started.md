...
<InternalLinkButton
  emoji="🏗️"
  text="How-to guides"
  to="/witnet-ecosystem-buidlers/how-to-guides/"
/>
...
Once a `node` instance is fully synced, its [JSON-RPC over TCP API](./reference-material/api-references/index.md) offers a minimal single-account, single-address wallet. Running a Witnet-Rust node with the JSON-RPC API exposed on local port `21338` can easily be achieved with this Docker one-liner:
...
<ExternalLinkButton
  image="medium.svg"
  title="Interacting with a Witnet node without CLI"
  website="https://medium.com/witnet/interacting-with-witnet-node-without-cli-7028e8f6cff7"
/>

The full list of supported JSON-RPC methods is available in the [Node API Reference](../node-operators/reference-material/api-references/node-api.md):

<InternalLinkButton
  text="Node API reference"
  to="/node-operators/reference-material/api-references/node-api"
/>
...
<InternalLinkButton
  text="Wallet API reference"
  to="/node-operators/reference-material/api-references/wallet-api"
/>
