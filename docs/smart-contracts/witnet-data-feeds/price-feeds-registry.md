...
This smart contract is deployed in all the [**supported chains**](addresses/) and allows your own smart contracts and Web3 applications to get the latest price of any of the [**supported currency pairs**](price-feeds-registry.md#currency-pairs) by providing the identifier of the pair to a single Solidity method. This removes the need to know the actual contract addresses handling the price updates from the Witnet oracle.
...
<!-- TODO> replace with custom inner link -->
