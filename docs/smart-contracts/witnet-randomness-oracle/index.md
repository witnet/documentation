...
<InternalLinkButton
  ...
  to="/smart-contracts/witnet-randomness-oracle/generating-randomness"
/>
<InternalLinkButton
  text="Randomness requests"
  to="/smart-contracts/witnet-randomness-oracle/randomness-requests"
/>
<InternalLinkButton
  text="Randomness contract"
  to="/smart-contracts/witnet-randomness-oracle/randomness-contract"
/>
<InternalLinkButton
  text="Code examples"
  to="/smart-contracts/witnet-randomness-oracle/code-examples"
/>
<InternalLinkButton
  text="API reference"
  to="/smart-contracts/witnet-randomness-oracle/api-reference"
/>
<InternalLinkButton
  text="Contract addresses"
  to="/smart-contracts/witnet-randomness-oracle/contract-addresses"
/>
