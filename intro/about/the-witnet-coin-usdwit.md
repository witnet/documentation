...
{% hint style="info" %}
_The WIT token in **Ethereum** supports bridging to some L2 chains, such as **Base**. Please, get_ [_here_](https://github.com/witnet/witnet-wrapped-wit/blob/master/README.md#-supported-networks) _an up-to-date list of supported L2s._
{% endhint %}
...
<figure><img src="../../.gitbook/assets/Group 709.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Group 706.png" alt="" width="563"><figcaption></figcaption></figure>
...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/GZhmMVmWgA8E_gU.png" alt=""><figcaption><p>Staking in Witnet is designed to be as fair as possible.</p></figcaption></figure></div>

You can view the current staked supply and estimate your potential earnings using this calculator:

{% embed url="https://staking.witnet.io" %}

Learn how to stake your native WIT into a validator node and start earning rewards with this tutorial:

{% content-ref url="../tutorials/mining-wit.md" %}
