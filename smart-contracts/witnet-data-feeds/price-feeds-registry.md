...
{% hint style="tip" %}
For the sake of simplicity, currency pairs served by the Witnet's Price Router can also be identified by just using the first 4 bytes of the `bytes32` identifier.
{% endhint %}
