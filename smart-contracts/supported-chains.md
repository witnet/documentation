...
| **Hoo Smart Chain** (HSC)        | <ul><li>testnet</li></ul>                                                                         | <ul><li><a href="witnet-data-feeds/addresses/hsc-price-feeds.md">Price Feeds</a></li><li><a href="witnet-randomness-oracle/contract-addresses.md#hoo-smart-chain">Randomness</a></li><li><a href="witnet-web-oracle/contracts-addresses.md#hoo-smart-chain">HTTP GET/POST</a></li></ul> |
...
| ----------------------- | ----------------------------------------- | ------------ |
| **Hoo Smart Chain**     | <ul><li>mainnet</li></ul>                 | ETA: 2022 Q2 |
