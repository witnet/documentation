---
description: >-
  Use the Witnet SDK to build, sign, send and await finalization of Witnet
  transactions.
---
...
{% hint style="info" %}
_Intrinsic transactions cannot be built out from the Witnet SDK._
{% endhint %}

## Building Witnet transactions

{% hint style="success" %}
_Transaction factories in the **Witnet SDK** can be attached to either a **Wallet**, an **Account** or a **Signer** object. This will determine the variety of different signers that may end up signing one single transaction._&#x20;
{% endhint %}
